                            ...
                            <div className="flex items-center gap-1.5">
                              ...
                              {onHabitDelete && (
                                <button
                                  ...
                                  className="p-1 hover:bg-red-100 dark:hover:bg-red-900/30 rounded transition-colors text-red-500 hover:text-red-700"
                                  title="Delete habit"
                                >
                                  <Trash2 className="w-3.5 h-3.5" />
                                </button>
              ...
              >
                ...
                {completion ? (
                  <div className="space-y-4">
                    ...
                    >
                      <TimeSlider
                        value={completion.actual_minutes ?? habit.estimated_minutes}
                        min={Math.max(0, Math.round(habit.estimated_minutes * 0.5))}
                        max={Math.round(habit.estimated_minutes * 1.5)}
                        estimated={habit.estimated_minutes}
                        onChange={(minutes) => {
                          if (completion) {
                            handleUpdate(completion.id, { actual_minutes: minutes });
                          }
                        }}
                      />
                    </div>
